...
if (!supabaseUrl || !supabaseKey) {
  console.error(
    'Missing Supabase connection details. Please set SUPABASE_URL (or NEXT_PUBLIC_SUPABASE_URL) and SUPABASE_SERVICE_ROLE_KEY (or SUPABASE_SECRET_KEY/SUPABASE_ANON_KEY).'
  );
  process.exit(1);
}
