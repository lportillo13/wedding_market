const common = {
  ...
  "footer": {
    ...
    "newsletter": {
      ...
      "errorMessage": "We couldn't subscribe you right now. Please try again."
    },
    "contact": {
  ...
  "login": {
    ...
    "resetDescription": "Enter the email for your account and we’ll send you a secure reset link.",
    "resetSubmit": "Send reset link",
    "resetSubmitting": "Sending reset link...",
    "resetSent": "If an account exists for that email, a password reset link is on its way. Check your inbox and spam folder.",
    "resetBack": "Back to log in",
    "newPasswordTitle": "Choose a new password",
    "newPasswordDescription": "Use at least 8 characters. For your security, this reset link can only be used once.",
    ...
    "recoveryExpired": "This reset link is invalid or has expired. Request a new one.",
    "passwordUpdated": "Your password was updated. You can now log in with your new password."
  },
  "shortlistButton": {
