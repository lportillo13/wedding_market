...
export default function Home() {
  ...
  const magazineCopy = MAGAZINE_COPY[language];
        ...
        <div className="container">
          <div className="wm-home-magazine__layout">
            <div className="wm-home-magazine__copy">
              <p className="wm-home-magazine__eyebrow">{magazineCopy.eyebrow}</p>
              <p className="wm-home-magazine__issue">{magazineCopy.issue}</p>
              <h2 id="wm-home-magazine-title">
                {magazineCopy.title}
                <em>{magazineCopy.titleAccent}</em>
              </h2>
              <p className="wm-home-magazine__description">{magazineCopy.description}</p>
              <Link href="/blog" className="wm-home-magazine__cta">
                <span>{magazineCopy.cta}</span>
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
            ...
            <Link href="/blog" className="wm-home-magazine__media" aria-label={magazineCopy.imageCta}>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/magazine/digital-magazine-editorial.webp" alt={magazineCopy.imageAlt} />
              <span className="wm-home-magazine__cover-mark" aria-hidden="true">
                <span>{magazineCopy.coverLabel}</span>
                <strong>{magazineCopy.coverIssue}</strong>
              </span>
