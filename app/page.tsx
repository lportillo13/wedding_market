...
export default function Home() {
  ...
  const { hero, highlights, categories, plan } = dictionary.home;
        ...
        <div className="container">
          <div className="row align-items-center g-5">
            <div className="col-lg-7">
              <span className="badge bg-primary-subtle text-primary-emphasis mb-3">{hero.badge}</span>
              <h1 className="display-4 fw-bold text-primary mb-4">{hero.title}</h1>
              <p className="lead text-secondary mb-4">{hero.description}</p>
            ...
            <div className="col-lg-5">
              <div className="card shadow-sm border-0 overflow-hidden">
                <div className="card-body p-4">
                  <h2 className="h5 text-uppercase text-secondary mb-3">{highlights.heading}</h2>
        ...
        <div className="container">
          <div className="row align-items-center g-4">
            <div className="col-lg-6">
              <h2 className="display-6 fw-bold mb-3">{categories.heading}</h2>
              <p className="text-secondary">{categories.description}</p>
            </div>
            <div className="col-lg-6">
        ...
        <div className="container">
          <div className="row justify-content-center text-center">
            <div className="col-lg-8">
              <h2 className="display-6 fw-bold mb-3">{plan.heading}</h2>
