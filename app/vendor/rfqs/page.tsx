...
export default async function VendorRfqsPage() {
  ...
  if (!vendor) {
    return (
      <main className="container py-4" style={{ maxWidth: 960 }}>
        <h1 className="mb-3">Received RFQs</h1>
  ...
  return (
    <main className="container py-4" style={{ maxWidth: 960 }}>
      <h1 className="mb-1">Received RFQs</h1>
      ...
      {!items.length ? (
        ...
        <div className="vstack gap-3">
          {items.map(({ invite, rfq, latestQuote, quotesForRfq }) => {
                ...
                <div className="card-body">
                  <div className="d-flex justify-content-between align-items-start">
                    <div>
                      ...
                      <h5 className="card-title mb-1">RFQ {invite.rfq_id.slice(0, 8)}…</h5>
                  ...
                  {latestQuote && (
                    <div className="mt-3 p-3 border rounded bg-body-tertiary">
                      <div className="d-flex justify-content-between align-items-center">
                        <div className="fw-semibold">Latest quote</div>
                        <div>
                  ...
                  <QuoteForm rfq_id={invite.rfq_id} vendor_id={vendor.id} />
                </div>
              </div>
            );
          })}
