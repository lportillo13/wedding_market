  ...
  return (
    <div>
        ...
        <form action={heroAction} encType="multipart/form-data">
          ...
          <button className="btn btn-primary btn-sm" disabled={heroPending} type="submit">
            {heroPending
              ...
              : t("vendorDashboard.profileImages.uploadSingle")}
          </button>
        </form>
      ...
      <div>
        ...
        <p className="text-muted small mb-3">{t("vendorDashboard.profileImages.galleryHelp")}</p>
        ...
        <form action={galleryAction} encType="multipart/form-data">
          ...
          <button className="btn btn-primary btn-sm" disabled={galleryPending} type="submit">
            {galleryPending
              ? t("vendorDashboard.profileImages.uploading")
              : t("vendorDashboard.profileImages.uploadMultiple")}
          </button>
        </form>
        <div className="form-text mt-1 mb-3">
          {t("vendorDashboard.profileImages.gallerySelectHelp")}
        </div>
