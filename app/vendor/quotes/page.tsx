...
export default async function VendorQuotesPage() {
  ...
  if (!vendor) {
    return (
      <main className="container py-4" style={{ maxWidth: 960 }}>
        <h1 className="mb-3">Quotes sent</h1>
  ...
  if (!quoteRows.length) {
    return (
      <main className="container py-4" style={{ maxWidth: 960 }}>
        <h1 className="mb-3">Quotes sent</h1>
        <div className="alert alert-secondary">You haven’t sent any quotes yet.</div>
      </main>
    );
  }
  ...
  return (
    <main className="container py-4" style={{ maxWidth: 960 }}>
      <h1 className="mb-1">Quotes sent</h1>
              ...
              <div className="card-body">
                ...
                {contactRevealed ? (
                  ...
                  <div className="mt-3 small text-secondary">
                    ...
                    Contact details unlock automatically once your quote is accepted.
                  </div>
                )}
              </div>
            </div>
